...
| Official builtin tools package | Runtime extension | Runtime Core extension (in-process) | [tool and capability](design/tool-and-capability.md#official-builtin-tools-extension), [D14](design/key-design-decisions.md#d14---concrete-tool-ids-live-outside-runtime-core) | Runtime core provides no concrete tool ids; `awaken-ext-builtin-tools` supplies hand, task, and unified delegation toolsets that execute in-process |
