...
[HTTP API](./http-api.md). The console is built so that **no UI element
...
- [Use the Admin Console](../how-to/use-admin-console.md) — operator user manual
- [HTTP API](./http-api.md) — endpoint reference
- [Enable Observability](../how-to/enable-observability.md) — turn on
