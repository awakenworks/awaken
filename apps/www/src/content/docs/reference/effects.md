---
title: "Effects"
description: "Effects are typed, fire-and-forget side-effect events. Unlike scheduled actions (which execute within a phase convergence loop and can cascade), effects are dispatched after commit and are terminal…"
---

Effects are typed, fire-and-forget side-effect events. Unlike
[scheduled actions](/awaken/reference/scheduled-actions/) (which execute within a phase
...
- [Plugin Internals](/awaken/explanation/plugin-internals/)
