...
description: "The AG-UI adapter translates Awaken's AgentEvent stream into the AG-UI (CopilotKit) event format. This enables CopilotKit frontends to drive Awaken agents with no custom adapter code."
---
