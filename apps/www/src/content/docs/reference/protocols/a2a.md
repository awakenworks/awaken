---
title: "A2A Protocol"
description: "The Agent-to-Agent (A2A) adapter implements the A2A protocol for remote agent discovery, task delegation, and inter-agent communication."
---
...
- [Multi-Agent Patterns](/awaken/explanation/multi-agent-patterns/) — delegation and handoff design
