---
title: "Thread Model"
description: "Threads represent persistent conversations. A thread owns metadata and a small run projection; messages, runs, and dispatch attempts are stored separately."
---
