---
title: "Cancellation"
description: "Cooperative cancellation token used to interrupt agent runs, streaming loops, and long-running operations."
---
...
**Crate path:** `awaken_runtime_contract::cancellation::CancellationToken`
