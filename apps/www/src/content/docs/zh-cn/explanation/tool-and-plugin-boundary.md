---
title: "Tool 与 Plugin 的边界"
description: "Awaken 明确区分“给 LLM 使用的能力”（tools）和“运行时生命周期扩展”（plugins）。本页解释两者的边界、适用场景以及交互方式。"
---
...
- [添加 Tool](/how-to/add-a-tool/)
- [添加 Plugin](/how-to/add-a-plugin/)
