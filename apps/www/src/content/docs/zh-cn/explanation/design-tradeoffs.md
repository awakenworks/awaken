---
title: "设计取舍"
description: "本页总结 Awaken 几个关键架构决策及其权衡。"
---
...
- [架构](/awaken/zh-cn/explanation/architecture/) -- 三层设计
- [状态与快照模型](/awaken/zh-cn/explanation/state-and-snapshot-model/) -- Snapshot Isolation 详解
- [Run 生命周期与 Phases](/awaken/zh-cn/explanation/run-lifecycle-and-phases/) -- phase 执行模型
- [Tool 与 Plugin 的边界](/awaken/zh-cn/explanation/tool-and-plugin-boundary/) -- plugin 与 tool 的设计边界
