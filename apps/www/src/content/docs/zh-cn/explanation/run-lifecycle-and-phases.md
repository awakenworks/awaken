---
title: "Run 生命周期与 Phases"
description: "本页描述 run 和 tool call 的状态机、9 个 phase、终止条件、checkpoint 触发点，以及挂起 / 恢复如何桥接 run 层与 tool-call 层。"
---
...
- [工具执行模式](/awaken/zh-cn/reference/tool-execution-modes/)
