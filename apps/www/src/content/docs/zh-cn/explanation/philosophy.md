...
- [架构](/zh-cn/explanation/architecture/) —— 三层 runtime 结构
- [Run 生命周期与 Phases](/zh-cn/explanation/run-lifecycle-and-phases/) —— 九个阶段
- [状态与快照模型](/zh-cn/explanation/state-and-snapshot-model/) —— 合并策略详解
- [HITL 与 Mailbox](/zh-cn/explanation/hitl-and-mailbox/) —— 挂起 / 恢复语义
- [设计取舍](/zh-cn/explanation/design-tradeoffs/) —— 我们考虑过的替代方案
