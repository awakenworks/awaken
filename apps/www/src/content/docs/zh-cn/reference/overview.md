---
title: "概览"
description: "awaken crate 是 Awaken 的公开门面。它把 awaken-contract、awaken-runtime、awaken-stores 以及若干扩展 crate 的公共 API 重新导出为一个统一依赖面。"
---
...
- [Effects](/zh-cn/reference/effects/)
