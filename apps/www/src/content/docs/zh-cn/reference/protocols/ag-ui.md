---
title: "AG-UI 协议"
description: "AG-UI 适配层会把 Awaken 的 AgentEvent 流转换成 AG-UI / CopilotKit 事件格式，使 CopilotKit 前端可以直接驱动 Awaken agent。"
---
...
- [事件](/events/)
- [集成 CopilotKit (AG-UI)](/../how-to/integrate-copilotkit-ag-ui/)
