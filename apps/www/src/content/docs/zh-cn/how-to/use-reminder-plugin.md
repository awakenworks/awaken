---
title: "使用 Reminder 插件"
description: "当你希望 agent 在工具执行后，根据模式匹配自动收到上下文提示时，使用本页。例如：修改 .toml 后提醒执行 cargo check，或在危险命令后给出警告。"
---
...
- [启用工具权限 HITL](/enable-tool-permission-hitl/) -- 使用相同的工具模式 DSL
