---
title: "Integrate CopilotKit (AG-UI)"
description: "Use this when you have a CopilotKit React frontend and need to connect it to an awaken agent server via the AG-UI protocol."
---
