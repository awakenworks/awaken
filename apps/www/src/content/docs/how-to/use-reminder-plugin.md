---
title: "Use the Reminder Plugin"
description: "Use this when you want the agent to receive automatic context messages after tool execution based on pattern matching -- for example, reminding the agent to run cargo check after editing a .toml…"
---
...
- [Enable Tool Permission HITL](/enable-tool-permission-hitl/) -- uses the same tool pattern DSL
