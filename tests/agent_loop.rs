...
use awaken::agent::state::{InferenceOverrides, RunLifecycle, RunLifecycleState, ToolCallStates};
...
impl Plugin for LoopStatePlugin {
    ...
    fn register(&self, registrar: &mut PluginRegistrar) -> Result<(), StateError> {
        ...
        registrar.register_key::<InferenceOverrides>(StateKeyOptions::default())?;
        Ok(())
    }
}
