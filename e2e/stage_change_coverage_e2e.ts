...
const scenarios: Scenario[] = [
  ...
  { id: 'secretless_worker', file: 'e2e/secretless_gateway_worker_e2e.ts' },
...
const obligations: Obligation[] = [
  ...
  { id: 'D3-05', stage: '3 worker identity/scope', behavior: 'real worker reuses one identity for claim/commit/settle', scenario: 'secretless_worker' },

  { id: 'D4-01', stage: '4 secretless model access', behavior: 'model_access survives durable enqueue and claim unchanged', scenario: 'worker_transport' },
  { id: 'D4-02', stage: '4 secretless model access', behavior: 'claimed dispatch contains no provider key', scenario: 'worker_transport' },
  { id: 'D4-03', stage: '4 secretless model access', behavior: 'real awaken-worker forwards the grant to ExecutorProvider', scenario: 'secretless_worker' },
  { id: 'D4-04', stage: '4 secretless model access', behavior: 'provider-selected executor drives the model result', scenario: 'secretless_worker' },
  { id: 'D4-05', stage: '4 secretless model access', behavior: 'worker runs with provider key variables removed', scenario: 'secretless_worker' },
  { id: 'D4-06', stage: '4 secretless model access', behavior: 'grant-routed result commits and settles exactly once', scenario: 'secretless_worker' },
