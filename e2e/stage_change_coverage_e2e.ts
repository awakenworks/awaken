...
const scenarios: Scenario[] = [
  ...
  { id: 'sealed_credential_worker', file: 'e2e/sealed_credential_worker_e2e.ts' },
...
const obligations: Obligation[] = [
  ...
  { id: 'D4-E01', stage: '4 credential injection', behavior: 'a recipient-bound envelope with a mismatched payload fingerprint fails before provider I/O', scenario: 'sealed_credential_worker' },
  { id: 'D4-E02', stage: '4 credential injection', behavior: 'an exact envelope cannot be replayed for a different endpoint binding', scenario: 'sealed_credential_worker' },
  { id: 'D4-E03', stage: '4 credential injection', behavior: 'an expired envelope fails closed before material resolution', scenario: 'sealed_credential_worker' },
  { id: 'D4-E04', stage: '4 credential injection', behavior: 'an envelope addressed to another Worker trust domain fails closed', scenario: 'sealed_credential_worker' },
  { id: 'D4-E05', stage: '4 credential injection', behavior: 'the exact recipient, target, use, payload and claim epoch resolve once and commit one provider reply', scenario: 'sealed_credential_worker' },
