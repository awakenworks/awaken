...
|---|---|---|---|
| `beta.agents.archive` | `/v1/agents` | ✅ covered | `management_agents_e2e.mjs` |
...
| `beta.agents.versions.list` | `/v1/agents/{agent_id}/versions` | ✅ covered | `management_agents_e2e.mjs` |
...
| `beta.deployments.archive` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
...
| `beta.deployments.pause` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
| `beta.deployments.retrieve` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
| `beta.deployments.run` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
| `beta.deployments.unpause` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
| `beta.deployments.update` | `/v1/deployments` | ✅ covered | `management_deployments_e2e.mjs` |
| `beta.dreams.archive` | `/v1/dreams` | ✅ covered | `managed_dream_e2e.ts` |
| `beta.dreams.cancel` | `/v1/dreams` | ✅ covered | `managed_dream_e2e.ts` |
...
| `beta.environments.archive` | `/v1/environments` | ✅ covered | `management_environments_e2e.mjs` |
...
| `beta.environments.work.ack` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.heartbeat` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.list` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.poll` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.poller` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_official_worker_e2e.mjs` |
| `beta.environments.work.retrieve` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.stats` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.stop` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.update` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_work_depth_e2e.mjs` |
| `beta.environments.work.worker` | `/v1/environments/{environment_id}/work` | ✅ covered | `management_environment_worker_full_e2e.mjs` |
| `beta.files.delete` | `/v1/files` | ✅ covered | `management_files_models_e2e.mjs` |
| `beta.files.download` | `/v1/files` | ✅ covered | `managed_resources_api_e2e.mjs` |
...
| `beta.memoryStores.archive` | `/v1/memory_stores` | ✅ covered | `management_memory_stores_e2e.mjs` |
...
| `beta.memoryStores.memories.create` | `/v1/memory_stores/{memory_store_id}/memories` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memories.delete` | `/v1/memory_stores/{memory_store_id}/memories` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memories.list` | `/v1/memory_stores/{memory_store_id}/memories` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memories.retrieve` | `/v1/memory_stores/{memory_store_id}/memories` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memories.update` | `/v1/memory_stores/{memory_store_id}/memories` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memoryVersions.list` | `/v1/memory_stores/{memory_store_id}/memory_versions` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memoryVersions.redact` | `/v1/memory_stores/{memory_store_id}/memory_versions` | ✅ covered | `management_memory_stores_e2e.mjs` |
| `beta.memoryStores.memoryVersions.retrieve` | `/v1/memory_stores/{memory_store_id}/memory_versions` | ✅ covered | `management_memory_stores_e2e.mjs` |
...
| `beta.sessions.archive` | `/v1/sessions` | ✅ covered | `management_sessions_family_e2e.mjs` |
...
| `beta.sessions.events.list` | `/v1/sessions/{session_id}/events` | ✅ covered | `managed_e2e.mjs` via `harness.mjs#waitForSessionEventReceipt` |
| `beta.sessions.events.send` | `/v1/sessions/{session_id}/events` | ✅ covered | `managed_e2e.mjs` |
| `beta.sessions.events.stream` | `/v1/sessions/{session_id}/events` | ✅ covered | `managed_e2e.mjs` |
| `beta.sessions.events.toolRunner` | `/v1/sessions/{session_id}/events` | ✅ covered | `managed_session_tool_runner_matrix_e2e.mjs` |
| `beta.sessions.list` | `/v1/sessions` | ✅ covered | `management_sessions_family_e2e.mjs` |
| `beta.sessions.resources.add` | `/v1/sessions/{session_id}/resources` | ✅ covered | `managed_resource_lifecycle_e2e.mjs` |
| `beta.sessions.resources.delete` | `/v1/sessions/{session_id}/resources` | ✅ covered | `managed_resource_lifecycle_e2e.mjs` |
| `beta.sessions.resources.list` | `/v1/sessions/{session_id}/resources` | ✅ covered | `managed_resource_lifecycle_e2e.mjs` |
| `beta.sessions.resources.retrieve` | `/v1/sessions/{session_id}/resources` | ✅ covered | `managed_resource_lifecycle_e2e.mjs` |
| `beta.sessions.resources.update` | `/v1/sessions/{session_id}/resources` | ✅ covered | `managed_session_resource_rotation_e2e.mjs` |
| `beta.sessions.retrieve` | `/v1/sessions` | ✅ covered | `management_sessions_family_e2e.mjs` |
| `beta.sessions.threads.archive` | `/v1/sessions/{session_id}/threads` | ✅ covered | `management_session_threads_e2e.mjs` |
| `beta.sessions.threads.events.list` | `/v1/sessions/{session_id}/threads/{thread_id}/events` | ✅ covered | `management_session_threads_e2e.mjs` |
| `beta.sessions.threads.events.stream` | `/v1/sessions/{session_id}/threads/{thread_id}/events` | ✅ covered | `management_session_threads_e2e.mjs` |
| `beta.sessions.threads.list` | `/v1/sessions/{session_id}/threads` | ✅ covered | `management_session_threads_e2e.mjs` |
| `beta.sessions.threads.retrieve` | `/v1/sessions/{session_id}/threads` | ✅ covered | `management_session_threads_e2e.mjs` |
...
| `beta.skills.versions.create` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `beta.skills.versions.delete` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `beta.skills.versions.download` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `beta.skills.versions.list` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `beta.skills.versions.retrieve` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `beta.tunnels.archive` | `/v1/tunnels` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.tunnels.certificates.archive` | `/v1/tunnels/{tunnel_id}/certificates` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.tunnels.certificates.create` | `/v1/tunnels/{tunnel_id}/certificates` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.tunnels.certificates.list` | `/v1/tunnels/{tunnel_id}/certificates` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.tunnels.certificates.retrieve` | `/v1/tunnels/{tunnel_id}/certificates` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
...
| `beta.tunnels.revealToken` | `/v1/tunnels` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.tunnels.rotateToken` | `/v1/tunnels` | ✅ covered | `management_tunnels_contract_e2e.mjs` |
| `beta.userProfiles.create` | `/v1/user_profiles` | ✅ covered | `management_user_profiles_e2e.mjs` |
| `beta.userProfiles.createEnrollmentURL` | `/v1/user_profiles` | ✅ covered | `management_user_profiles_e2e.mjs` |
...
| `beta.vaults.archive` | `/v1/vaults` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.create` | `/v1/vaults` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.archive` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.create` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.delete` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.list` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.mcpOAuthValidate` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_e2e.mjs` |
| `beta.vaults.credentials.retrieve` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
| `beta.vaults.credentials.update` | `/v1/vaults/{vault_id}/credentials` | ✅ covered | `management_vaults_family_e2e.mjs` |
...
| `beta.webhooks.unwrap` | `offline-standard-webhooks` | ✅ covered | `managed_webhooks_official_sdk_e2e.mjs` |
| `files.delete` | `/v1/files` | ✅ covered | `management_files_models_e2e.mjs` |
| `files.download` | `/v1/files` | ✅ covered | `managed_namespace_session_environment_e2e.mjs` |
...
| `skills.versions.create` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `skills.versions.delete` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `skills.versions.list` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
| `skills.versions.retrieve` | `/v1/skills/{skill_id}/versions` | ✅ covered | `management_skills_e2e.mjs` |
