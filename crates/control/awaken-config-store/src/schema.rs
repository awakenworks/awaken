...
pub fn config_bundle() -> Result<MigrationBundle, MigrationError> {
    ...
    migrations.push(Migration::published_legacy_per_dialect_with_aliases(
        5,
        ...
        std::iter::empty::<&str>(),
        // SQLite orders by its built-in `rowid`; nothing to add. This exact
        // already-published inert body remains pinned for receipt compatibility.
