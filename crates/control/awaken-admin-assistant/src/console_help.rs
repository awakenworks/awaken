...
const TOPICS: &[Topic] = &[
    Topic {
        ...
        what: "The console is grouped by what you're doing: Author (Agents), Building blocks, Run, Supply, and Govern.",
        ...
        how: "Author an Agent through Quickstart, Build, and Advanced → compose shared building blocks → give it a model (Supply) → run and inspect Sessions.",
    ...
    Topic {
        ...
        location: "Author ▸ Agents. Open one to move through Quickstart / Build / Advanced.",
    ...
    Topic {
        ...
        location: "The Building blocks rail group; bindings are set under Agent ▸ Build.",
        how: "Create the block in its surface, then bind it under Build ▸ Memory & resources or Build ▸ Skills & MCP.",
    ...
    Topic {
        ...
        how: "Quickstart: template + runnable model + Environment + first task → review the diff → Publish & run. Continue in Build or Advanced.",
