...
mod tests {
    ...
    fn admin_bundle_lints() {
        ...
        // order (C1) and the scoped receipt is absent (C2) => V0009/V0010 execute
    ...
    fn versions_parse_contiguously_from_file_names() {
        ...
        // R1 empty ledger + V1..V10 => build the current Control schema.
        // R2 published prefix + the same V1..V10 => apply only its missing suffix.
