...
pub use credential::{
    ...
    CredentialMaterialSource, CredentialObservation, CredentialObservationSource,
    CredentialObservationState, CredentialRealizationCapabilities, CredentialRealizationKind,
    CredentialRealizationPlan, CredentialRealizationProfile, CredentialRealizationReceipt,
    CredentialRealizationRecordError, CredentialRealizationRecorder, CredentialReceiptError,
    CredentialRef, CredentialRefreshAccess, CredentialUsage, ModelExposurePolicy,
    OAuthCredentialMaterial, PlaintextBoundary, PlaintextHolder, ResolvedCredentialMaterial,
    SealedCredentialEnvelopeRef, TokenEndpointAuth, TrustDomainRef, WorkerLocalCredentialResolver,
