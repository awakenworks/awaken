...
///
/// Actions are emitted by [`AgentBehavior`](super::super::agent::AgentBehavior)
...
/// [`core`](super::core) module. Extension plugins can define their own
/// actions by implementing this trait.
