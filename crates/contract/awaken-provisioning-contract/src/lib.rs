...
pub use sandbox::{
    ...
    ContainerSandboxHandleV2, ExitStatus, HostBindRestorationHandle, IsolationClass,
    IsolationPolicy, KubernetesPodUid, LocalSandboxHandleV1, LocalSandboxHandleV2,
    MemoryMaterializationEvidence, MemoryMaterializationHead, MemoryMount, MemoryMounter,
    MemoryReconciliationAck, NamespaceProviderKind, NamespaceSandboxHandleV1,
    NamespaceSandboxHandleV2, OnUnmet, PolicySelection, ProcessHandle,
    RepositoryHttpBasicCredential, RepositoryPublicationError, RepositoryPublicationExpectation,
    RepositoryPublicationReceipt, RepositoryPublicationRejection, RepositoryRealizationPlan,
    RepositoryRealizer, ResourceInputDefaultMounts, Sandbox, SandboxCapabilities,
    SandboxCheckpointRef, SandboxCheckpointRequest, SandboxCheckpointStore,
    SandboxControlIncarnation, SandboxDisposalAuthorization, SandboxDisposalPreparation,
    SandboxEffectFence, SandboxError, SandboxHandle, SandboxObservation, SandboxProvider,
    SandboxRequirements, SandboxRestorationEvidence, SandboxRestoreRequest, SandboxRestoreResult,
    SandboxRestoreTarget, SandboxRestoreTargetDisposition, SandboxStatus, SecretBroker,
    SecretWritebackEffect, SelectionError, Signal, StoredCheckpointObject, WorkspaceLayout,
    capability_requirements_satisfied, checkpoint_exclusions_fingerprint,
    resource_input_default_mounts, sandbox_spec_security_fingerprint, select_provider,
    select_provider_with_policy, validate_checkpoint_exclusions_for_spec,
    validate_repository_mount_path, validate_repository_mount_paths,
    validate_repository_sandbox_adoption_layout, validate_repository_sandbox_layout,
};
pub use spec::{
    ...
    SandboxRealizationFingerprint, SandboxSpec, Stdio, materialize_process_command,
};
pub use vocab::{
