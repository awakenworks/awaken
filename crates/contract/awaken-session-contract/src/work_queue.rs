...
//! in its signatures and the default in-memory implementation. The Managed wire
//! adapter owns the neutral→wire projection (`WorkItem` → `BetaSelfHostedWork`); this
//! crate names no wire type.
