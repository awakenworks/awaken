...
use awaken_run_executor_acp::{
    AcpDetectionState, AcpDiscovery, AcpHostDiscovery, AcpHostObservation, acp_cli,
};
use awaken_runtime_contract::CredentialObservationState;
pub use awaken_worker::AcpLocalCredentialResolver;
...
mod tests {
    ...
    use awaken_credential_vault::{CredentialSource, CredentialStatus};
