...
pub(super) struct FileConfig {
    ...
    pub(super) package_artifact_dir: Option<PathBuf>,
    pub(super) package_build_lease_secs: Option<u64>,
    pub(super) package_build_wait_secs: Option<u64>,
    pub(super) package_failure_retry_secs: Option<u64>,
    pub(super) package_state_ttl_secs: Option<u64>,
