//! `awaken-protocol-managed-resources` — thin per-plane HTTP router adapters over the host.
//!
...
//! a thin adapter — the composition layer (`awaken-coordinator`) mounts them onto the app.
//!
