...
//! - `user_profile` — the `user-profiles` resource. **NB: separate versioned
//!   betas** for pinned and latest reviewed SDKs, not
//!   `managed-agents-2026-04-01`; see the module doc.
