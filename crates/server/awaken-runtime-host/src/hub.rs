...
pub enum ThreadEvent {
    ...
    /// An external ACP agent's bring-up progressed (launching the process,
    /// initializing the handshake, ready, or failed). A UI renders this as a
    /// "starting agent…" affordance.
