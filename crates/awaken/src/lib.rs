...
pub use awaken_contract::{
    ...
    PluginConfigKey, RecordMeta, RecordSource, RedactedString, SKILL_SPEC_UNKNOWN_FIELD_POLICY,
    ScheduledActionSpec, SkillArgumentSpec, SkillSpec, SkillSpecContext, SkillSpecPatch,
    ...
    sanitize_for_llm, validate_against_schema, validate_agent_spec, validate_agent_spec_patch,
