use awaken_runtime_contract::registry_spec::{AgentSpec, McpServerSpec, ModelSpec, ProviderSpec};
use awaken_runtime_contract::{BuiltinSeedSet, BuiltinSpec, SkillSpec};
